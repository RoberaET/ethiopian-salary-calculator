...
export const metadata: Metadata = {
  ...
  description: 'Free Ethiopian salary calculator 2026. Calculate your net pay, income tax (PAYE), and pension contributions with current Ethiopian tax brackets.',
  keywords: 'Ethiopian salary calculator, Ethiopia tax calculator, Ethiopian income tax calculator, PAYE Ethiopia, net salary Ethiopia, tax brackets Ethiopia 2026, Addis Ababa salary calculator, Ethiopian payroll calculator, HR tools Ethiopia, salary calculator Addis Ababa',
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        {/* Critical Meta Tags */}
        <title>Ethiopian Salary Calculator 2026 - Free Tax & Net Pay</title>
        <link rel="preconnect" href="https://fonts.googleapis.com" />
        <link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="anonymous" />
        <link href="https://fonts.googleapis.com/css2?family=Alfa+Slab+One&display=swap" rel="stylesheet" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=5.0, user-scalable=yes" />
        <meta name="description" content="Free Ethiopian salary calculator 2026. Calculate your net pay, income tax (PAYE), and pension contributions with current Ethiopian tax brackets." />
